            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <small class="text-white-50">
                        Registo de um novo equipamento no sistema
                    </small>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        >
                            ...
                            @forelse($responsaveis as $responsavel)
                                ...
                                <option
                                    ...
                                    @selected(old('responsavel_id') == $responsavel->id)
                                >
                                    {{ $responsavel->name }}
                        ...
                        <div class="responsavel-info mt-1">
                            ...
                            Apenas utilizadores com o perfil
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            id="plaqueta"
                            name="plaqueta"
                            class="form-control form-control-modern @error('plaqueta') is-invalid @enderror"
                            placeholder="Ex: PLA-2024-001"
                            value="{{ old('plaqueta') }}"
                            required
                        >
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            placeholder="Ex: Intel Core i7-12700 / AMD Ryzen 7"
                            value="{{ old('modelo_cpu') }}"
                            required
                        >
                ...
                <div class="alert alert-light border rounded-3 d-flex align-items-start gap-2 mb-4">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            O computador será associado ao responsável selecionado.
                            O sistema impede a associação a utilizadores
                            Helpdesk.
                        </small>
