...
class RetirementController extends Controller
{
    ...
    public function create()
    {
        /*
        |--------------------------------------------------------------------------
        | Buscar computadores que ainda não foram aposentados
        |--------------------------------------------------------------------------
        */
    ...
    public function store(Request $request)
    {
        $dadosValidados = $request->validate([
            ...
            |
            | Não usar:
            | Rule::exists('sintech.computers', 'id')
            |
            | Porque "sintech" é o schema e não uma conexão.
            |
            | O Model Computer já sabe que sua tabela é:
            | sintech.computers
            |
            */
        ...
        */
        ...
        $jaAposentado = Retirement::where(
            'computer_id',
            $dadosValidados['computer_id']
        )->exists();
        ...
        if ($jaAposentado) {
            ...
            return back()
                ...
                ->withErrors([
                    'computer_id' =>
                        'Este computador já possui um registo de aposentação.',
                ]);
        }
        ...
        */
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Computador aposentado com sucesso.'
            );
    }
    ...
    public function edit(string $id)
    {
        ...
        |--------------------------------------------------------------------------
        |
        | Mostra computadores que ainda não estão aposentados.
        |
        | Também mantém disponível o computador atualmente associado
        | a este registo.
        |
        */
    ...
    public function update(Request $request, string $id)
    {
        ...
        */
        ...
        $computadorDuplicado = Retirement::where(
                'computer_id',
                $dadosValidados['computer_id']
            )
            ->where(
        ...
        if ($computadorDuplicado) {
            ...
            return back()
                ...
                ->withErrors([
                    'computer_id' =>
                        'Este computador já possui outro registo de aposentação.',
                ]);
        }
        ...
        */
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Registo de aposentação atualizado com sucesso.'
            );
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Registo de aposentação eliminado com sucesso.'
            );
    }
}